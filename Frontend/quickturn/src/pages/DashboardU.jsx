...
import ProjectsU from '../features/ProjectsU';
import ApplicantsModalU from '../components/ApplicantsModalU';
    ...
    <div className="dashboard-container">
      ...
      <header className="mobile-top-header">
        <div className="mobile-top-header-inner">
          ...
          >
            <span className="mobile-profile-name">{user?.name?.split(' ')[0] || 'Client'}</span>
